      ...
      <div v-for="(user, index) in users.data" :key="index">
        ...
        >
          <div class="flex items-center relative">
            <div class="relative">
              <img
                :src="[user.photo != '' ? user.photo : 'https://images.unsplash.com/photo-1549078642-b2ba4bda0cdb?ixlib=rb-1.2.1&amp;ixid=eyJhcHBfaWQiOjEyMDd9&amp;auto=format&amp;fit=facearea&amp;facepad=3&amp;w=144&amp;h=144']"
                :alt="user.name"
